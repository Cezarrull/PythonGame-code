...
while condicao_jogar_novamente_ou_parar != 1:
    ...
    while cont < 10:
            ...
            if mensagem_chute == 1:
                print('''\nPRIMEIRO CHUTE... VAI LÁ!''')
            else:     
                print('''\nAguardando tentativa...''')
            print(f'''\nTentativas restantes: {10-tentativas}''')
            
            print(f'''Digitos descobertos são: {primeiro_digito} {segundo_digito} {terceiro_digito} {quarto_digito}''')
            ...
            print(f'''Seus digitos certos são: {primeiro_digito_input} {segundo_digito_input} {terceiro_digito_input} {quarto_digito_input}''')
            cont += 1
